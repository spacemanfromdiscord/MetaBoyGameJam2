...
public class GameMenu : MonoBehaviour {
    ...
    public Text[] statusStr, statusDef, statusAgility, statusWpnEqpd, statusWpnPwr, statusArmrEqpd, statusArmrPwr;
    ...
    public GameObject[] skillCharacterSlots;
    public GameObject skillCharacterSlotsMenu;
    public Text[] nameTextSkill;
    public Text[] hpTextSkill;
    public Text[] spTextSkill;
    public Text[] lvlTextSkill;
    public Slider[] HPSliderSkill;
    public Slider[] SPSliderSkill;
    public Slider[] expSliderSkill;
    public Image[] charImageSkill;
    public bool skillSelected;
    public Button[] skillCharChoice;
    public int selectedSkillPower;
    public int selectedSkillCost;
    public int selectedSkillChar;
    public bool selectedSkillHealStatusEffects;
    public GameObject[] mainPoisonText;
    public GameObject[] mainSilenceText;
    public GameObject[] itemPoisonText;
	...
	void Update () {
        ...
        if (!GameManager.instance.battleActive)
        {
            if (Input.GetButtonDown("RPGCanclePC") || Input.GetButtonDown("RPGCancleJoy"))
            {
                ...
                if (selectP1Skill.interactable && !skillSelected)
                {
                ...
                //Skill buttons menu
                if (skillsWindow.activeInHierarchy && !skillSelected)
                {
                    skillsMenu.SetActive(false);
                    for (int i = 0; i < playerStats.Count; i++)
                    {
                        charSkillsButtons[i].GetComponent<Button>().interactable = true;
                    }
                ...
                {
                    skillSelected = false;
                    skillCharacterSlotsMenu.SetActive(false);
                    ...
                    btn = skillButtons[0].GetComponent<Button>();
                    SelectFirstButton();
                }
    ...
    public void UpdateMainStats()
    {
        ...
        for (int i = 0; i < playerStats.Count; i++)
        {
            if (playerStats[i].gameObject.activeInHierarchy)
            {
                ...
                skillCharacterSlots[i].SetActive(true);
                ...
                mainPoisonText[i].SetActive(playerStats[i].poisoned);
                mainSilenceText[i].SetActive(playerStats[i].silenced);
                ...
                itemPoisonText[i].SetActive(playerStats[i].poisoned);
                itemSilenceText[i].SetActive(playerStats[i].silenced);
                ...
                //Update skill menu info
                nameTextSkill[i].text = playerStats[i].characterName;
                hpTextSkill[i].text = playerStats[i].currentHP + " / " + playerStats[i].maxHP;
                HPSliderSkill[i].maxValue = playerStats[i].maxHP;
                HPSliderSkill[i].value = playerStats[i].currentHP;
                spTextSkill[i].text = playerStats[i].currentSP + " / " + playerStats[i].maxSP;
                SPSliderSkill[i].maxValue = playerStats[i].maxSP;
                SPSliderSkill[i].value = playerStats[i].currentSP;
                lvlTextSkill[i].text = "" + playerStats[i].level;
                expSliderSkill[i].maxValue = playerStats[i].eXPToNextLevel[playerStats[i].level];
                expSliderSkill[i].value = playerStats[i].currentEXP;
                charImageSkill[i].sprite = playerStats[i].characterIamge;

                skillPoisonText[i].SetActive(playerStats[i].poisoned);
                skillSilenceText[i].SetActive(playerStats[i].silenced);
    ...
    public void CloseMenu()
    {
        ...
        for (int i = 0; i < menuCharacterSlots.Length; i++)
        {
            menuCharacterSlots[i].SetActive(false);
            itemMenuCharacterSlots[i].SetActive(false);
            equipMenuCharacterSlots[i].SetActive(false);
        }
    ...
    public void OpenSkills()
    {
        ...
        {
            charSkillsButtons[i].SetActive(false);
        }
    ...
    public void ShowSkills(int charNumber)
    {
        ...
        selectedSkillChar = charNumber;

        for (int i = 0; i < playerStats.Count; i++)
        {
            charSkillsButtons[i].GetComponent<Button>().interactable = false;
        }
        ...
        for (int i = 0; i < skillButtons.Length; i++)
        {
            if (playerStats[charNumber].skills.Length > i)
            {
                ...
                skillButtons[i].usingChar = charNumber;
    ...
    public void UseSkill(int buttonValue)
    {
        if (playerStats[selectedSkillChar].currentSP >= selectedSkillCost && playerStats[selectedSkillChar].currentHP > 0)
        {
            if (!selectedSkillHealStatusEffects)
            {
                if (playerStats[buttonValue].currentHP > 0 && playerStats[buttonValue].currentHP < playerStats[buttonValue].maxHP)
                {
                    playerStats[buttonValue].currentHP += selectedSkillPower;

                    if (playerStats[buttonValue].currentHP > playerStats[buttonValue].maxHP)
                    {
                        playerStats[buttonValue].currentHP = playerStats[buttonValue].maxHP;
                    }

                    if (!GameManager.instance.infiniteSP)
                    {
                        playerStats[selectedSkillChar].currentSP -= selectedSkillCost;
                    }
            ...
            if (selectedSkillHealStatusEffects)
            {
                if (playerStats[buttonValue].poisoned || playerStats[buttonValue].silenced)
                {
                    playerStats[buttonValue].poisoned = false;
                    playerStats[buttonValue].silenced = false;
    ...
    public void StatusChar()
    {
        ...
        for (int i = 0; i < playerStats.Count; i++)
        {
            if (playerStats[i].gameObject.activeInHierarchy)
            {
                ...
                statusAgility[i].text = playerStats[i].agility.ToString();
        ...
        if (activeItem != null)
        {
            ...
            for (int i = 0; i < playerStats.Count; i++)
            {
                if (i < 3)
                {
                    ...
                    itemCharChoiceNames[i].transform.parent.gameObject.SetActive(true);
                }
    ...
    public void OpenEquipCharChoice()
    {
        ...
        if (activeItem != null)
        {
            ...
            for (int i = 0; i < playerStats.Count; i++)
            {
                ...
                equipCharChoiceNames[i].transform.parent.gameObject.SetActive(true);
            }
